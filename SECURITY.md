...
[Contact Info](https://www.fothz.com/security-report)
...
Our [Responsible Disclosure](https://www.fothz.com/security-report) page gives an overview of the
process, including:
...
We receive a majority of security reports that have little to no impact on the security of Fothz or
the Fothz Cloud, and we ultimately have to reject them. To avoid a disappointing experience when
...
Also be sure to review our list of [non-qualifying issues](https://www.fothz.com/security-report#what).
