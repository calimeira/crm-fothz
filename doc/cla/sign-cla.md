...
In order for your contribution to Fothz to be accepted, you have to sign the
Fothz Contributor License Agreement (CLA). More information about this
...
3. An Fothz R&D Team member will verify and accept your Pull Request. You can
...
2.  Modify your current pull request, or make a new pull request on
    ...
    If the name of the company is Fothz, the file would be
    `doc/cla/corporate/odoo.md`. The file should contain:

```
<country>, <date>

<company-name> agrees to the terms of the Fothz Corporate Contributor License
Agreement v1.0.
...
`cla-submission` `at` `fothz.com`.  In that case someone from the Fothz team will
make the pull request on your behalf.

* Printable Fothz CCLA v1.0 https://www.fothz.com/files/legal/Fothz-CCLA-v1.0.pdf
* Printable Fothz ICLA v1.0 https://www.fothz.com/files/legal/Fothz-ICLA-v1.0.pdf

# FAQ

## Why do I need to accept a CLA ?

The goal of having a Contributor License Agreement for Fothz is to:

* clearly define the terms under which intellectual property (patches, pull
  requests, etc.) have been contributed to the Fothz project

* protect the Fothz project and its users in case of legal dispute about the
  origin or ownership of any part of the code

* protect the Fothz project and its users from bad actors who would contribute
...
contributor really intended to contribute to the Fothz project under specific
...
The Fothz CLA is based on the Apache Software Foundation CLA v2.0, as
...
irrevocable license to the project maintainer, Fothz S.A. to use, modify and
...
(ICLA) of Fothz.  The agreement is executed by adding your name and
...
removed from the Fothz project.
