...
class ResConfigSettings(models.TransientModel):
    ...
    app_system_name = fields.Char('System Name', help="Setup System Name,which replace Odoo",
                                  default='Fothz AI', config_parameter='app_system_name')
    ...
    app_account_title = fields.Char('My fothz.com Account Title', config_parameter='app_account_title')
    app_account_url = fields.Char('My fothz.com Account Url', config_parameter='app_account_url')
    ...
    # 应用帮助文档
    app_doc_root_url = fields.Char('Help of topic domain', config_parameter='app_doc_root_url', default='https://fothz.com')
    ...
    def set_module_url(self, rec=None):
        ...
        app_enterprise_url = config_parameter.get_param('app_enterprise_url', 'https://www.fothz.com')
