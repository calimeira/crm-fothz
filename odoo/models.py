...
class BaseModel(metaclass=MetaModel):
    """Base class for Fothz models.

    Fothz models are created by inheriting one of the following:
    ...
    *   :class:`AbstractModel` for abstract super classes meant to be shared by
    ...
    _module = None              #: the model's module (in the Fothz sense)
...
class Model(AbstractModel):
    """ Main super-class for regular database-persisted Fothz models.

    Fothz models are created by inheriting from this class::
