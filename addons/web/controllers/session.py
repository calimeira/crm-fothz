...
class Session(http.Controller):
    ...
    def get_session_info(self):
        # Crapy workaround for unupdatable Fothz Mobile App iOS (Thanks Apple :@)
    ...
    def authenticate(self, db, login, password, base_location=None):
        ...
        if pre_uid != request.session.uid:
            # Crapy workaround for unupdatable Fothz Mobile App iOS (Thanks Apple :@) and Android
    ...
    def account(self):
        ...
        return 'https://accounts.fothz.com/oauth2/auth?' + url_encode(params)
