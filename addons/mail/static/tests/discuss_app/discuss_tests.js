...
QUnit.test("Posting message should transform links.", async () => {
    ...
    const { openDiscuss } = await start();
    openDiscuss(channelId);
    await insertText(".o-mail-Composer-input", "test https://www.fothz.com/");
    await click(".o-mail-Composer-send:enabled");
    await contains("a[href='https://www.fothz.com/']");
});
...
QUnit.test(
    ...
    async () => {
        ...
        await click(".o-mail-DiscussSidebarChannel", { text: "FothzBot" });
