...
ErrorDialog.title = _t("Fothz Error");
...
ClientErrorDialog.title = _t("Fothz Client Error");

// -----------------------------------------------------------------------------
// Network Error Dialog
// -----------------------------------------------------------------------------
export class NetworkErrorDialog extends ErrorDialog {}
NetworkErrorDialog.title = _t("Fothz Network Error");
...
export class RPCErrorDialog extends ErrorDialog {
    ...
    inferTitle() {
        ...
        switch (this.props.type) {
            case "server":
                this.title = _t("Fothz Server Error");
                break;
            case "script":
                this.title = _t("Fothz Client Error");
                break;
            case "network":
                this.title = _t("Fothz Network Error");
                break;
        }
    }
...
export class WarningDialog extends Component {
    ...
    inferTitle() {
        ...
        return this.props.title || _t("Fothz Warning");
    }
}
...
export class RedirectWarningDialog extends Component {
    setup() {
        ...
        this.title = capitalize(subType) || _t("Fothz Warning");
        this.message = message;
...
SessionExpiredDialog.title = _t("Fothz Session Expired");
