...
QWeb is the primary templating engine used by Fothz. It is an XML templating
...
<https://www.fothz.com/documentation/17.0/developer/reference/frontend/qweb.html>`
...
The generated code uses ``user_has_groups`` Fothz method.
    ...
    def _debug_trace(self, debugger, values):
        ...
        if not debugger:
            ...
            warnings.warn(
                ...
                "since Fothz 17.0, keep the value empty and configure the "
