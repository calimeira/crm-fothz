...
class TestHttpMisc(TestHttpBase):
    ...
    def test_misc3_is_static_file(self):
        ...
        self.assertEqual(root.get_static_file(f'fothz.com/{uri}', host='fothz.com'), path, "Valid file with valid host")
        self.assertEqual(root.get_static_file(f'http://fothz.com/{uri}', host='fothz.com'), path, "Valid file with valid host")
        ...
        self.assertIsNone(root.get_static_file(f'fothz.com/{uri}'), "No host allowed")
        self.assertIsNone(root.get_static_file(f'http://fothz.com/{uri}'), "No host allowed")
