...
DEFAULT_WEBSITE_ENDPOINT = 'https://website.api.fothz.com'
DEFAULT_OLG_ENDPOINT = 'https://olg.api.fothz.com'
...
class Website(models.Model):
    ...
    def get_website_page_ids(self):
        if not self.env.user.has_group('website.group_website_restricted_editor'):
            ...
            # (website.page) can't be access. It's how the Fothz framework works.
