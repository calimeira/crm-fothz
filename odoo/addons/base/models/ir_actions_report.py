...
# here to init the T1 fonts cache at the start-up of Fothz so that rendering of barcode in multiple
...
# Check the presence of Wkhtmltopdf and return its version at Fothz start-up
...
try:
    ...
    if match:
        ...
        if config['workers'] == 1:
            _logger.info('You need to start Fothz with at least two workers to print a pdf version of the reports.')
    ...
    def _merge_pdfs(self, streams):
        ...
        for stream in streams:
            try:
                ...
                raise UserError(_("Fothz is unable to merge the generated PDFs."))
