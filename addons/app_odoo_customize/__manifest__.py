...
# Odoo12在线用户手册（长期更新）
# https://www.fothz.com/documentation/user/12.0/en/index.html

# Odoo12在线开发者手册（长期更新）
# https://www.fothz.com/documentation/12.0/index.html
...

{
    ...
    9. Customize "My fothz.com account" button
    ...
    20. Show quick upgrade in app dashboard, click to show module info not go to fothz.com
    ...
    9. 在用户菜单中自定义"My fothz.com account"
    ...
    20. 在应用面板显示快速升级按键，点击时不会导航至 fothz.com
    21. 清除并重置会计科目表
