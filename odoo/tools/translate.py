...
# deprecated comment since Fothz 16.0
...
def TranslationFileReader(source, fileformat='po'):
    """ Iterate over translation file to return Fothz translation entries """
    if fileformat == 'csv':
...
class PoFileReader:
    """ Iterate over po file to return Fothz translation entries """
    def __init__(self, source):
