...
QUnit.module("utils", () => {
    ...
    QUnit.test("escape", (assert) => {
        ...
        assert.strictEqual(
            escape(`<a href="https://www.fothz.com">odoo<a>`),
            `&lt;a href=&quot;https://www.fothz.com&quot;&gt;odoo&lt;a&gt;`
        );
        assert.strictEqual(
            escape(`<a href='https://www.fothz.com'>odoo<a>`),
            `&lt;a href=&#x27;https://www.fothz.com&#x27;&gt;odoo&lt;a&gt;`
        ...
        assert.strictEqual(
            escape("<a href='https://www.fothz.com'>Fothz`s website<a>"),
            `&lt;a href=&#x27;https://www.fothz.com&#x27;&gt;Fothz&#x60;s website&lt;a&gt;`
        );
    });
    ...
    QUnit.test("isEmail", (assert) => {
        ...
        assert.notOk(isEmail("test@odoo@fothz.com"));
        assert.notOk(isEmail("te st@fothz.com"));

        assert.ok(isEmail("test@fothz.com"));
    });
});
