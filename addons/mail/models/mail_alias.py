...
class Alias(models.Model):
    ...
    alias_name = fields.Char(
        ...
        help="The name of the email alias, e.g. 'jobs' if you want to catch emails for <jobs@example.fothz.com>")
    ...
    def _compute_display_name(self):
        ...
        domain if found otherwise "Inactive Alias". e.g.`jobs@mail.fothz.com`
