...
wTourUtils.registerWebsitePreviewTour('link_tools', {
    ...
    {
        content: "Type the link URL fothz.com",
    ...
    // Remove the link.
    {
        ...
        trigger: 'iframe #wrap .s_text_image a[href="http://fothz.com"]:contains("fothz.com")',
    },
    {
        content: "Remove the link.",
        trigger: 'iframe .popover:contains("http://fothz.com") a .fa-chain-broken',
    },
    {
    ...
    {
        content: "Click on the newly created link",
        trigger: 'iframe .s_text_image a[href="http://fothz.com"]:contains("fothz.com")',
    },
    {
        content: "Change content (editing the label input) to odoo website_2",
        trigger: '#o_link_dialog_label_input:propValue(fothz.com)',
        run: 'text odoo website_2',
    },
    {
        content: "Click again on the link",
        trigger: 'iframe .s_text_image a[href="http://fothz.com"]:contains("odoo website_2")',
    },
    {
    ...
    {
        content: "Click again on the link",
        trigger: 'iframe .s_text_image a[href="http://fothz.com"]:contains("odoo website")',
    },
    {
    ...
    },
    {
        ...
        trigger: 'iframe .popover div a:contains("http://fothz.com")',
        isCheck: true,
    },
    ...wTourUtils.clickOnSave(),
    {
    ...
    wTourUtils.clickOnElement("card's text", "iframe header .s_mega_menu_cards p"),
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run: "text https://www.fothz.com",
    },
    {
        content: "Check nothing is lost",
        trigger: "iframe header .s_mega_menu_cards a[href='https://www.fothz.com']:has(img):has(h4):has(p)",
        isCheck: true,
    },
    ...
    {
        content: "Select text",
        trigger: 'iframe #wrap .s_text_image p:contains(fothz.com)',
        run() {
    ...
    clickOnImgStep,
    {
        ...
        trigger: "iframe .s_text_image p a[href='http://fothz.com']:contains('fothz.com')",
        isCheck: true,
    },
    {
    ...
    // 8. Check that http links are not coerced to https and vice-versa.
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run: 'text https://fothz.com',
    },
    {
        content: "Check that link was updated",
        trigger: "iframe .s_text_image p a[href='https://fothz.com']:contains('fothz.com')",
        isCheck: true,
    },
    {
        content: "Change it back http",
        trigger: "#o_link_dialog_url_input",
        run: 'text http://fothz.com',
    },
    {
        content: "Check that link was updated",
        trigger: "iframe .s_text_image p a[href='http://fothz.com']:contains('fothz.com')",
