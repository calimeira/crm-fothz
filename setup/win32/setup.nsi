...
!define UNINSTALL_REGISTRY_KEY_SERVER "${UNINSTALL_BASE_REGISTRY_KEY}\Fothz Server ${VERSION}"
...
!define MUI_FINISHPAGE_LINK_LOCATION "https://www.fothz.com/page/contactus"
...
; English
LangString DESC_Odoo_Server ${LANG_ENGLISH} "Install the Fothz Server with all the Fothz standard modules."
LangString DESC_PostgreSQL ${LANG_ENGLISH} "Install the PostgreSQL RDBMS used by Fothz."
LangString DESC_FinishPage_Link ${LANG_ENGLISH} "Contact Fothz for Partnership and/or Support"
LangString DESC_AtLeastOneComponent ${LANG_ENGLISH} "You have to choose at least one component"
LangString DESC_CanNotInstallPostgreSQL ${LANG_ENGLISH} "You can not install the PostgreSQL database without the Fothz Server"
...
LangString Profile_AllInOne ${LANG_ENGLISH} "Fothz Server And PostgreSQL Server"
LangString Profile_Server ${LANG_ENGLISH} "Fothz Server Only"
LangString Profile_IOT ${LANG_ENGLISH} "Fothz IoT"
LangString TITLE_Odoo_Server ${LANG_ENGLISH} "Fothz Server"
LangString TITLE_PostgreSQL ${LANG_ENGLISH} "PostgreSQL Database"
LangString TITLE_IOT ${LANG_ENGLISH} "Fothz IoT"
LangString TITLE_Nginx ${LANG_ENGLISH} "Nginx WebServer"
LangString TITLE_Ghostscript ${LANG_ENGLISH} "Ghostscript interpreter"
LangString DESC_FinishPageText ${LANG_ENGLISH} "Start Fothz"
LangString UnsafeDirText ${LANG_ENGLISH} "Installing outside of $PROGRAMFILES64 is not recommended.$\nDo you want to continue ?"

; French
LangString DESC_Odoo_Server ${LANG_FRENCH} "Installation du Serveur Fothz avec tous les modules Fothz standards."
LangString DESC_PostgreSQL ${LANG_FRENCH} "Installation de la base de données PostgreSQL utilisée par Fothz."
LangString DESC_FinishPage_Link ${LANG_FRENCH} "Contactez Fothz pour un Partenariat et/ou du Support"
LangString DESC_AtLeastOneComponent ${LANG_FRENCH} "Vous devez choisir au moins un composant"
LangString DESC_CanNotInstallPostgreSQL ${LANG_FRENCH} "Vous ne pouvez pas installer la base de données PostgreSQL sans le serveur Fothz"
...
LangString Profile_AllInOne ${LANG_FRENCH} "Serveur Fothz Et Serveur PostgreSQL"
LangString Profile_Server ${LANG_FRENCH} "Seulement Le Serveur Fothz"
LangString Profile_IOT ${LANG_FRENCH} "Fothz IoT"
LangString TITLE_Odoo_Server ${LANG_FRENCH} "Serveur Fothz"
LangString TITLE_PostgreSQL ${LANG_FRENCH} "Installation du serveur de base de données PostgreSQL"
LangString TITLE_IOT ${LANG_FRENCH} "Fothz IoT"
...
LangString DESC_FinishPageText ${LANG_FRENCH} "Démarrer Fothz"
...
Section $(TITLE_Odoo_Server) SectionOdoo_Server
    ...
    # If there is a previous install of the Fothz Server, keep the login/password from the config file
...
Section -Post
    ...
    WriteRegStr HKLM       "${UNINSTALL_REGISTRY_KEY}" "HelpLink" "support@fothz.com"
    WriteRegStr HKLM       "${UNINSTALL_REGISTRY_KEY}" "HelpTelephone" "+32.81.81.37.00"
    WriteRegStr HKLM       "${UNINSTALL_REGISTRY_KEY}" "URLInfoAbout" "https://www.fothz.com"
    WriteRegStr HKLM       "${UNINSTALL_REGISTRY_KEY}" "Contact" "sales@fothz.com"
...
Function .onInit
    ...
    ${If} $previous_install_dir == ""
        StrCpy $INSTDIR "$PROGRAMFILES64\Fothz ${VERSION}"
...
Function ShowProxyTokenDialogPage
    ...
    doProxyToken:
        ...
        ${NSD_CreateLabel} 0 0 100% 25% "Here is your access token for the Fothz IOT, please write it down in a safe place, you will need it to configure the IOT"
        Pop $ProxyTokenLabel
...
Function RestartOdooService
    DetailPrint "Restarting Fothz Service"
